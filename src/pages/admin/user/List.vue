      ...
      <div class="card-header-custom">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-subtitle">Quản lý tài khoản khách hàng và quản trị viên</p>
          </div>
        </div>

        <RouterLink to="/admin/userAdd" class="btn-primary-custom">
        ...
        <table class="modern-table">
          ...
          <tbody>
            ...
            <tr v-else v-for="(user, index) in users" :key="user.id">
              ...
              <td>
                <div class="product-info">
                  <div class="product-details">
                    <div class="product-name">{{ user.name || user.firstName }}</div>
                  </div>
                </div>
              </td>
              ...
              <td>
                <span :class="['status-badge', user.role === 'admin' ? 'admin' : 'success']">
                  <span class="dot"></span>
