    ...
    <div class="form-card">
      <div class="card-header-custom">
        <div class="header-left">
          ...
          <div>
            <h2 class="page-title">Thêm Món Mới</h2>
            <p class="page-subtitle">Nhập thông tin sản phẩm để thêm vào danh sách</p>
          </div>
        </div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-8">
              <div class="form-group mb-4">
                <label class="form-label-custom">Tên Món <span class="required">*</span></label>
                <div class="input-wrapper">
                  <i class="bi bi-cup-straw input-icon"></i>
                  <input type="text" class="form-control-custom" placeholder="Ví dụ: Cà phê sữa đá" v-model="name" />
                </div>
              ...
              <div class="form-group mb-4">
                <label class="form-label-custom">Mô Tả Sản Phẩm <span class="required">*</span></label>
                <textarea class="form-control-custom textarea-custom" rows="4" placeholder="Nhập mô tả chi tiết về món..." v-model="description"></textarea>
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                  <i class="bi bi-check2-circle me-2"></i> Lưu Món
                </button>
              </div>
            </div>
          </div>
